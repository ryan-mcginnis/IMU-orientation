function Rinf = get_orientation_optim(time, a, w, ind)
...
Rinf = get_orientation(time, a, wnew, params.ind);
...
RUF = get_orientation(t, params.a, wnew, params.ind);
wG = dcmRot(permute(RUF(:,:,params.indG),[2,1,3]), params.direction); %gravity direction in body frame
